...
public class ClienteJuridicoDAOImpl implements ClienteJuridicoDAO {
	...
	private static final Logger log= LogManager.getLogger(ClienteJuridicoDAOImpl.class);
	...
	public int insertarJuridicoCliente(ClienteJuridicoBean clienteJuridico) {
		...
		try{
			...
			e.printStackTrace();
			log.error("error en Mi conexion insertarJuridicoCliente" + e);
		}finally {
	...
	public List<ClienteJuridicoBean> listaClienteJuridico() {
		...
		try {
			...
			e.printStackTrace();
			log.error("error en Mi conexion listaClienteJuridico" + e);
		}
	...
	public int eliminarClienteJuridico(Long idClienteJuridico) {
		...
		try{
			...
			e.printStackTrace();
			log.error("error en Mi conexion eliminarClienteJuridico" + e);
		}finally {
	...
	public ClienteJuridicoBean obtenerClienteJuridicoById(Long idClienteJuridico) {
		...
		try {
			...
			e.printStackTrace();
			log.error("error en Mi conexion obtenerClienteJuridicoById" + e);
		}
	...
	public int actualizarClienteJuridico(ClienteJuridicoBean clienteJuridico) {
		...
		try{
			...
			e.printStackTrace();
			log.error("error en Mi conexion actualizarClienteJuridico" + e);
		}finally {

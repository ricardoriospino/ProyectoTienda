...
public class ClienteDAOImpl implements ClienteDAO {
	...
	private static final Logger log= LogManager.getLogger(ClienteDAOImpl.class);
	...
	public int insertarCliente(ClienteBean cliente) {
		...
		try{
			...
			e.printStackTrace();
			log.error("error en Mi conexion insertarCliente" + e);
		}finally {
	...
	public int eliminarClienteNatural(int id_cliente) {
		...
		try{
			...
			e.printStackTrace();
			log.error("error en Mi conexion eliminarClienteNatural" + e);
		}finally {
	...
	public ClienteBean obtenerClienteById(int id_cliente) {
		...
		try {
			...
			e.printStackTrace();
			log.error("error en Mi conexion obtenerClienteById " + e);
		}
	...
	public int actualizarClienteNatural(ClienteBean clienteNatural) {
		...
		try{
			...
			e.printStackTrace();
			log.error("error en Mi conexion actualizarClienteNatural" + e);
		}finally {

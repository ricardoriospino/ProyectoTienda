...
public class ServletInsertUpdateClienteJuridico extends HttpServlet {
	...
	private static final Logger log= LogManager.getLogger(ServletInsertUpdateClienteJuridico.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		log.info("Inicia metodo doPost ServletInsertUpdateClienteJuridico");
		...
		log.debug("Datos de ingresados direccion " + direccionForm + " telefono " + telefonoForm + " codigo distrito" + 
		...
		if("insert".equals(accion)) {
			...
			log.debug("entro a actualizacion");
		...
		log.info("fin del metodo doPost() ServletInsertUpdateClienteJuridico");
	}

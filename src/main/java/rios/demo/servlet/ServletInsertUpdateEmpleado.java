...
public class ServletInsertUpdateEmpleado extends HttpServlet {
	...
	private static final Logger log= LogManager.getLogger(ServletInsertUpdateEmpleado.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		log.debug("Datos ingresados "+ nombreForm + "el apellido materno es " + apellidoMaternoForm + 
